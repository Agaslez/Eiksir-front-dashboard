...
const CTA = () => {
  ...
  return (
    <section
      id="kontakt"
      className="py-20 bg-gradient-to-b from-black to-amber-950/20"
    >
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-white/60 text-sm md:text-base max-w-2xl mx-auto">
            Masz pytania? Chcesz omówić szczegóły swojej imprezy? Jesteśmy do
            Twojej dyspozycji 7 dni w tygodniu.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black border border-amber-500/30 rounded-2xl p-8">
            ...
            <p className="text-gray-400 mb-8">
              Wypełnij formularz, a skontaktujemy się z Tobą w ciągu 24 godzin z
              indywidualną wyceną i propozycją.
            </p>
            ...
            >
              ...
              <p className="text-center text-gray-500 text-sm">
                Lub zadzwoń od razu:{' '}
                <span className="text-amber-400 font-bold">517-616-618</span>
              </p>
            </form>
          </div>
        </div>
